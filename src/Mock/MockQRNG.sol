...
contract MockRrpRequesterV0 is RrpRequesterV0 {
    ...
    function makeTemplateRequest(
        ...
        bytes32 requestId = airnodeRrp.makeTemplateRequest(
            templateId, sponsor, sponsorWallet, fulfillAddress, fulfillFunctionId, parameters
        );
    ...
    function makeFullRequest(
        ...
        bytes32 requestId = airnodeRrp.makeFullRequest(
            airnode, endpointId, sponsor, sponsorWallet, fulfillAddress, fulfillFunctionId, parameters
        );
        expectingRequestWithIdToBeFulfilled[requestId] = true;
    }
    ...
    function fulfill(bytes32 requestId, bytes calldata data) external onlyAirnodeRrp {
        require(expectingRequestWithIdToBeFulfilled[requestId], "No such request made");
